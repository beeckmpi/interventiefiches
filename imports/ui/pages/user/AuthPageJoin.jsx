      ...
      <Paper id="table" style={paperTableStyle} zDepth={3}>
        <div style={{width:'80%', display:'inline-block'}}>
          <div className="formInput input-field">
            ...
            <TextField floatingLabelText="Naam" hintText="Naam" type="text" id="name" style={{width: '50%', display: 'inline-block'}} value={this.state.name} onChange={this.handleChange.bind(this)} />
          </div>
          <div className="formInput input-field">
